...
export default function StudioFolkbildningPage() {
 ...
 useEffect(() => {
 fetch("/api/folk-education/content")
 ...
 setError(null);
 try {
 const res = await fetch("/api/folk-education/content", {
 method: "PUT",
 ...
 <h1 className="mt-1">Folk Education</h1>
 ...
 Page heading <span className="font-normal text-gray-600">(centered H1)</span>
 </label>
 <div className="ml-8">
 ...
 <p className="mt-0.5">
 The page heading always appears at the top. Add and reorder
 blocks freely below.
 </p>
 </div>

 {blocks.length === 0 && (
 <p className="rounded-md border border-dashed border-gray-200 px-4 py-8 text-center">
