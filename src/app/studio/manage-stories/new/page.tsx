...
export default function StudioNyBerattelse() {
  ...
  const isDirty = name.trim().length > 0 || story.trim().length > 0;
  ...
  async function doSave() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/participant-stories", {
        method: "POST",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <h1 className="mt-1">New story</h1>
