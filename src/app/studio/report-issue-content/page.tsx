...
export default function StudioFelanmalanPage() {
 ...
 setError(null);
 try {
 const res = await fetch("/api/report-issue/content", {
 method: "PUT",
 ...
 <h1 className="mt-1">Report an Issue</h1>
 ...
 <p className="text-sm text-gray-600">This content is shown above the issue report form on the public page.</p>
 ...
 <SlideshowBlockEditor block={block} uploadPrefix="felanmalan" onChange={(patch) => updateBlock(block.id, patch)} />
 )}
 {block.type === "youtube" && (
