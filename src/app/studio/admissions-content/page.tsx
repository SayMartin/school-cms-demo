...
export default function StudioAnsokanPage() {
  ...
  async function doSave() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/admissions/content", {
        method: "PUT",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <h1 className="mt-1">Admission periods</h1>
      ...
      >
        ...
        <div className="space-y-3">
          <p className="text-sm text-gray-600">
            Use one section for instructions and one per course (H3 for the
            course name, then status and date). The &ldquo;Apply via
            SchoolSoft&rdquo; button is edited by a developer.
          </p>
