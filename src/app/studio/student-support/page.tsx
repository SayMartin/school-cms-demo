...
export default function StudioKurativtStodPage() {
 ...
 useEffect(() => {
 fetch("/api/student-support/content")
 ...
 setError(null);
 try {
 const res = await fetch("/api/student-support/content", {
 method: "PUT",
 ...
 <h1 className="mt-1">Student Support</h1>
 ...
 <SlideshowBlockEditor block={block} uploadPrefix="kurativt-stod" onChange={(patch) => updateBlock(block.id, patch)} />
 )}
 {block.type === "youtube" && (
