...
export default function StudioJobbPage() {
  ...
  async function doSave() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/careers/content", {
        method: "PUT",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <h1 className="mt-1">Open positions</h1>
      ...
      >
        ...
        <div className="space-y-3">
          <p className="text-sm text-gray-600">
            The &ldquo;Send speculative application&rdquo; button is always
            shown at the bottom of the page and is edited by a developer.
          </p>
