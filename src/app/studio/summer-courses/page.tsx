...
export default function StudioSommarkurserContentPage() {
  ...
  useEffect(() => {
    fetch("/api/summer-courses/content")
  ...
  async function doSave() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/summer-courses/content", {
        method: "PUT",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <h1 className="mt-1">Summer Courses — hub page</h1>
          ...
          {blocks.map((block, idx) => (
            ...
            >
              ...
              {block.type === "slideshow" && (
                <SlideshowBlockEditor block={block} uploadPrefix="sommarkurser" onChange={(patch) => updateBlock(block.id, patch)} />
              )}
              {block.type === "youtube" && (
